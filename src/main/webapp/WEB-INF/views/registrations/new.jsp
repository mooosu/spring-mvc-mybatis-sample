    ...
    <body>
        <div class="container">
            ...
            <div class="span-12 last">
                <c:url value="/registrations/create" var="create"/>
                <form:form modelAttribute="user" action="${create}" method="post">
                    <fieldset>
                        ...
                        <p>
                            <form:label	for="email" path="email" cssErrorClass="error">邮件</form:label><br/>
                        ...
                        <p>
                            <form:label for="confirmation_password" path="confirmation_password" cssErrorClass="error">确认密码</form:label><br/>
                            <form:password path="confirmation_password" /> <form:errors path="confirmation_password" />
                        </p>
                        <p>
